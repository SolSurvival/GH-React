...
<jsp:include page="header.jsp"/>
	...
	<main id="main">
		...
		<section class="inner-page">
			<div class="container">
				<h3 class="cover-heading">Place a Bid</h3>
				<br>
				...
				<br>
                <form class="row contact_form" action="bid?stockNumber=${listing.vehicle.stockNumber}" method="post" novalidate="novalidate">
                <div class="col-md-3 form-group p_star">
				<input type="text" class="form-control" id="bidAmt" name="bidAmt" placeholder="Bid Amount">
				</div>
