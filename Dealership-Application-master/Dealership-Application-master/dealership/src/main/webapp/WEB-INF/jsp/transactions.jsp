	...
	<main id="main">
		...
		<section class="inner-page">
			<div class="container">
				...
				<h2 class="cover-heading">Transaction History</h2>
				<br>
								<table class="table table-striped table-hover">
									<thead>
										<tr>
											...
											<th>Sale Date</th>
											<th>Customer Name</th>
											<th>Vehicle Details</th><!-- new or used -->
											<th></th><!-- year -->
											<th></th><!-- make -->
											<th></th><!-- model -->
											<th>Price</th>
								...
								<tbody>
									<c:forEach var="item" items="${transactions}">
										<tr>
											...
											<td>${item.listing.vehicle.newOrUsed}</td>
											<td>${item.listing.vehicle.year}</td>
											<td>${item.listing.vehicle.make}</td>
											<td>${item.listing.vehicle.model}</td>
