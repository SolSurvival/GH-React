...
<jsp:include page="header.jsp"/>
	...
	<main id="main">
		...
		<section class="inner-page">
			<div class="container">
				<h3 class="cover-heading">Payment Complete!</h3>
				<br>
				<h4>Your Transaction Details:</h4>
				<br>
				<div class="row align-items-center">
				<p>You have purchased a ${listing.vehicle.newOrUsed} ${listing.vehicle.year} 
				${listing.vehicle.make} ${listing.vehicle.model}</p>
				<ul>
				...
				<br>
				<h5 class="text-success"><em>Thank you for your business!</em></h5>
				<br>
				<a href="/welcome" class="text-info"><button class="myButton">Continue Browsing</button></a>
				</div>
			</div>
		</section>
