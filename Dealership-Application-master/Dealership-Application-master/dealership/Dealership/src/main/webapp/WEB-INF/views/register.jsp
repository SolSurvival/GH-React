                ...
                <div class="col-lg-6 col-md-6">
                    <div class="login_part_text text-center">
                        <div class="login_part_text_iner">
                            ...
                            <a href="login" class="btn_3">Login to your account</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6">
                    <div class="login_part_form">
                        <div class="login_part_form_iner">
                            ...
                            <form:form action="adduser" modelAttribute="user" method="Post" class="row contact_form">
							...
							<div class="col-md-12 form-group p_star">							
							<form:input path="email" type="email" class="form-control" placeholder="Enter E-mail "/>
							</div>
							<div class="col-md-12 form-group p_star">
